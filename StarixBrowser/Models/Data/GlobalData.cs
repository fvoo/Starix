...
namespace StarixBrowser.Models.Data
{
    public static class GlobalData
    {
        ...
        static GlobalData()
        {
            ...
            EmptyExePath = Path.Combine(AppBaseDirectory, @"StarixBrowser.EmptyExe.exe");
            ...
            DataPath = Path.Combine(UserDocumentPath, @"StarixBrowser\");
